...
# Tracking duration of music listening sessions based on energy levels.

This analysis researches data on music consumption and energy levels. Even though the data itself has information to make comparisons with music genres, listening location, time of day, etc. We will focus on how energy levels may be related to the duration of a music listening session, giving insight into how music affects our motivation on a day-to-day basis.
